...
local Text ="𖥔  تم الغاء منعها بنجاح*"
inline = {
{{text = 'sᴏᴜʀᴄʀ ᴛᴇʟᴀɴᴅ',url='http://t.me/ch_nasa'}},
}
...
local Text ="𖥔  تم الغاء منعه بنجاح*"
inline = {
{{text = 'sᴏᴜʀᴄʀ ᴛᴇʟᴀɴᴅ',url='http://t.me/ch_nasa'}},
}
https.request("https://api.telegram.org/bot"..token.."/deleteMessage?chat_id="..Chat_id.."&message_id="..msg_idd)
...
local Text ="𖥔  تم الغاء منع كل المتحركات*"
inline = {
{{text = 'sᴏᴜʀᴄʀ ᴛᴇʟᴀɴᴅ',url='http://t.me/ch_nasa'}},
}
https.request("https://api.telegram.org/bot"..token.."/deleteMessage?chat_id="..Chat_id.."&message_id="..msg_idd)
...
local Text ="𖥔  تم الغاء منع كل الصور*"
inline = {
{{text = 'sᴏᴜʀᴄʀ ᴛᴇʟᴀɴᴅ',url='http://t.me/ch_nasa'}},
}
https.request("https://api.telegram.org/bot"..token.."/deleteMessage?chat_id="..Chat_id.."&message_id="..msg_idd)
