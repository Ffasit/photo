...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/bandhot402/Som/main/File_Bot/commands.lua") 
...
local NameUser = "᪣ مـن قـبـل ⤌ ["..data.first_name_.."](T.me/"..UserName..")"
...
local keyboard = {
{'ضع اسم للبوت','معلومات الكيبورد','الاحصائيات'},
{'• ━━━━━━❪قسم السورس❫━━━━━━ •'},
{'⬇─════قـناه الـبرمجه════─⬇'},
{'قناه السورس','جروب توصل'},
{'• ━━━━━━❪قسم مسح &اضف❫━━━━━━ •'},
...
os.execute('wget https://raw.githubusercontent.com/bandhot402/Som/main/DRAGON.lua')
send(msg.chat_id_, msg.id_,'᪣ تم تحديث السورس')
dofile('DRAGON.lua')  
end
if text == 'الاصدار ' and DevSoFi(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ᪣ اصدار سورس سون{ s: 6.7}')
end
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'قـناه‍ الـسورس', url="t.me/Soon_ban"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/Soon_ban/40&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
if text == 'جروب توصل' and DevSoFi(msg) then
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
[TWL](t.me/D_vban25BOT)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'جروب توصل', url="t.me/TWASOLSOON"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
...
send(msg.chat_id_,0," ᪣ العضو : {["..data.first_name_.."](T.ME/Soon_ban)}\n ᪣ ["..DRAGON_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
sendText(msg.chat_id_,'\n ᪣ مـن قـبـل ⤌ ['..string.sub(result.first_name_,0, 70)..'](tg://user?id='..result.id_..')\n ᪣ تـم تـشغيل الـبوت فـي الجـروب {'..chat.title_..'}',msg.id_/2097152/0.5,'md')
...
Text = ' ᪣ تـم تـشغيل الـبوت فـي الجـروب \n'..
'\n ᪣ بواسطة {'..Name..'}'..
'\n ᪣ ايدي الجروب {'..IdChat..'}'..
'\n ᪣ اسم الجروب {['..NameChat..']}'..
...
sendText(msg.chat_id_,'\n ᪣ مـن قـبـل ⤌ ['..string.sub(result.first_name_,0, 70)..'](tg://user?id='..result.id_..')\n ᪣ تـم تـعطيل الـبوت  {'..chat.title_..'}',msg.id_/2097152/0.5,'md')
...
if database:sismember(bot_id..'Chek:Groups',msg.chat_id_) then
send(msg.chat_id_, msg.id_,' ᪣ تـم تـشغيل الـبوت فـي الجـروب')
else
sendText(msg.chat_id_,'\n ᪣ مـن قـبـل ⤌ ['..string.sub(result.first_name_,0, 70)..'](tg://user?id='..result.id_..')\n ᪣ تـم تـشغيل الـبوت فـي الجـروب {'..chat.title_..'}',msg.id_/2097152/0.5,'md')
database:sadd(bot_id..'Chek:Groups',msg.chat_id_)  
...
send(msg.chat_id_, msg.id_,' ᪣ تم تعيين عدد الاعضاء سيتـم تـشغيل الـبوت فـي الجـروبات التي اعضائها اكثر من  >> {'..Num..'} عضو')
end
...
local Text = [[
┍─━─━─┙[🅢🅞🅞🅝](t.me/Soon_ban)┕─━─━─┑
☞𝘄𝗲𝗹𝗰𝗼𝗺𝗲 𝘁𝗼 𝘀𝗼𝘂𝗿𝗰𝗲 𝘀𝗼𝗼𝗻☟
☞𝘁𝗵𝗲 𝗯𝗲𝘀𝘁 𝘀𝗼𝘂𝗿𝗰𝗲 𝗼𝗻 𝘁𝗲𝗹𝗲𝗴𝗿𝗮𝗺
┕─━─━─┑[🅢🅞🅞🅝](t.me/Soon_ban)┍─━─━─┙
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'قـناه الـبرمجه',url="t.me/U880p"}},
{{text = 'قـناه‍ الـسورس', url="t.me/Soon_ban"}},
{{text = 'جروب توصل',url="t.me/TWASOLSOON"}}, 
}
local msg_id = msg.id_/2097152/0.5
...
if text == "لوخيروك" or text == "خيرني" or text == "خيروك" then 
local TWEET_Msg = { 
...
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/vagwg/740&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
if text == '72-2525+$#' then
local Text = [[ 

]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '❨𝗦𝗔𝗠𝗘𝗘𝗥 ᪣❩',url="t.me/UU_bh"}},
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' ᪣ مـن قـبـل ⤌ ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'textchuser')..') \n ᪣ تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ᪣ مـن قـبـل ⤌ ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'textchuser')..') \n ᪣ تـم قفـل التاك بالكتم ')
end,nil)   
...
if DevSoFi(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/bandhot402/Som/main/getfile.json")
if res == 200 then
...
local json_file, res = https.request("https://raw.githubusercontent.com/bandhot402/Som/main/File_Bot/"..file)
if res == 200 then
...
if text == 'سلام' then 
send(msg.chat_id_,msg.id_, '[ابق تعاله كليوم..😹💔🎶](t.me/Soon_ban)')
return false
end

if text == 'هاي' or text == 'هيي' then
send(msg.chat_id_,msg.id_, '[علي الواي فاي..😺💜](t.me/Soon_ban)')
return false
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[نزل عينك عيب كده..🌚♥️](t.me/Soon_ban)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[يحلات عيونك..♥️🦋](t.me/Soon_ban)')
return false
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[عايز من ده..💋🥀](t.me/Soon_ban)')
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[خدوني معاكم بف..🙄💔](t.me/Soon_ban)')
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[متزعلش بحبك..😥♥️](t.me/Soon_ban)')
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[وانا كمان بحبك .🥺❤️](t.me/Soon_ban)')
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[خدوني معاكم بيف ..🙄💔](t.me/Soon_ban)')
return false
end
end
end
...
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&photo=https://t.me/Soon_ban/40&caption='..URL.escape(Teext)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
end
if Text == '/help4' then
if not Mod(data) then
local notText = '✘ عذرا الاوامر هذه لا تخصك'
...
{
{text = '🛡️القائمه الرائسيه🛡️', callback_data="/add"},
},
{
{text = 'قـناه‍ الـسورس', url="t.me/Soon_ban"},
},
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'لعبه البات', url="https://t.me/Soon_ban/2"},{text = 'لعبه الرياضيات',url="https://t.me/Soon_ban/3"}},   
{{text = 'لعبه المختلف', url="https://t.me/Soon_ban/8"},{text = 'لعبه السمايلات', url="https://t.me/Soon_ban/9"}}, 
{{text = 'لعبه التخمين', url="https://t.me/Soon_ban/12"},{text = 'لعبه العكس', url="https://t.me/Soon_ban/11"}}, 
{{text = 'لعبه الاسرع', url="https://t.me/Soon_ban/10"},{text = 'لعبه الانكليزي', url="https://t.me/Soon_ban/6"}}, 
{{text = 'لعبه حزوره', url="https://t.me/Soon_ban/5"},{text = 'لعبه المعاني', url="https://t.me/Soon_ban/4"}}, 
{{text = 'لعبه الامثله', url="https://t.me/Soon_ban/7"}},
{{text = 'قـناه‍ الـسورس', url="t.me/Soon_ban"}},
{{text = '🛡️القائمه الرائسيه🛡️', callback_data="/add"}},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Teext)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
...
keyboard.inline_keyboard = {
{
{text = '🛡️القائمه الرائسيه🛡️', callback_data="/change-id"},
},
{
{text = 'قـناه‍ الـسورس', url="t.me/Soon_ban"},
},
