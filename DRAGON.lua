...
if text == "تويت بالصوره" or text == "تويت صوره" or text == "تويت بالصوره"  and not  database:get(bot_id.."sing:for:me"..msg.chat_id_) then 
...
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&Photo=https://t.me/qeqi0q/'..ght..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == "كلمني" then
