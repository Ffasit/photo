...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/Qtdao/13&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
if not database:get(bot_id..'Cick:affa'..msg.chat_id_) then
database:set(bot_id..":"..msg.sender_user_id_..":affa_Bots"..msg.chat_id_,"sendaffa")
local LEADER_Msg = {
...
if text and text ~="كشف الكذب" and database:get(bot_id..":"..msg.sender_user_id_..":affa_Bots"..msg.chat_id_) == "sendaffa" then
...
sendnuj = numj[math.random(#numj)]
send(msg.chat_id_, msg.id_,xl) 
database:del(bot_id..":"..msg.sender_user_id_..":affa_Bots"..msg.chat_id_)
end
