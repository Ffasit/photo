...
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/'..b.username..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end,nil)
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '❲'..ta.title_..'❳', url="t.me/"..linkgpp.result}}, 
{{text = '00:00', url="t.me/Soon_ban"}},  
}   
