...
print('\27[0;31m◁━━━━◖❲🅢🅞🅞🅝❳◗━━━━▷n لم يتم حفظ ايدي المطور الاساسي ارسله مره اخره')
end 
os.execute('lua DRAGON.lua')
end
...
sudo_users = {SUDO,1770621216,1774315810,1859008079}   
...
function onall(msg)
local hash = database:sismember(bot_id..'Sudo:User'..msg.chat_id_,msg.sender_user_id_)    
if hash or SudoBot(msg) or DevSoFi(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
...
var = database:get(bot_id.."Sudo:Rd"..msg.chat_id_) or 'المدير العام'  
elseif database:sismember(bot_id..'Sudo:User'..chat_id, user_id) then
var = database:get(bot_id.."Sudo:Rd"..msg.chat_id_) or 'الادمن العام'  
elseif database:sismember(bot_id..'Manager'..chat_id, user_id) then
...
var = database:get(bot_id.."Memp:Rd"..msg.chat_id_) or 'الـعـضو '
end  
return var
end 
...
Text = '\n  ◍ بـالـتـاكـيـد تـم تـفعـيل التواصل '
end
...
Text = '\n  ◍ تـم تـعـطـيل التواصل' 
else
Text = '\n  ◍ بـالـتـاكـيـدتـم تـعـطـيل التواصل'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n  ◍  تـم تـفعـيل البوت الخدمي ' 
else
Text = '\n  ◍ بـالـتـاكـيـد تـم تـفعـيل البوت الخدمي '
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n  ◍ تـم تـعـطـيل البوت الخدمي' 
else
Text = '\n  ◍ بـالـتـاكـيـدتـم تـعـطـيل البوت الخدمي'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
if text == '• ━━━━━━❪الركن الاخير❫━━━━━━ •' then
local Text = [[ 
[قناه سورس سون ادخل وتابع الجديد](t.me/Soon_ban)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '❲×:×:×𝙲𝙷×:×:×❳', url="t.me/Soon_ban"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/vagwg/15&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/TWASOLSOON/1687&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
send(msg.chat_id_, msg.id_,'  ◍  البوت ادمن في القناة \n  ◍  تـم تـفعـيل الاشتراك الاجباري في \n  ◍  ايدي القناة ('..data.id_..')\n  ◍  معرف القناة ([@'..data.type_.channel_.username_..'])')
...
if msg.content_.ID == "MessageChatJoinByLink" then
database:del:get(bot_id.."UnKedDeleteMessage"..msg.chat_id_) == "open" then
https.request("https://api.telegram.org/bot"..token.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id="..msg.sender_user_id_)
...
sendText(msg.chat_id_,'\n ◍ تـم تـشغـيل الـبوت فـي جـروب  {'..chat.title_..'}\n◍ مـن قبـل ☜ ['..string.sub(result.first_name_,0, 70)..'](tg://user?id='..result.id_..')',msg.id_/2097152/0.5,'md')
...
sendText(msg.chat_id_,'\n◍ تـم تـعـطيل الـبـوت فـي جـروب {'..chat.title_..'}\n◍ مـن قبـل ☜ ['..string.sub(result.first_name_,0, 70)..'](tg://user?id='..result.id_..')',msg.id_/2097152/0.5,'md')
...
send(msg.chat_id_, msg.id_, "  ◍ تـم تـعـطـيل الاشتراك الاجباري ")
return false  
end
if text == "الاشتراك الاجباري " and DevSoFi(msg) then  
if database:get(bot_id..'add:ch:username') then
local addchusername = database:get(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_, "  ◍  تـم تـفعـيل الاشتراك الاجباري \n  ◍  على القناة  ☜ ["..addchusername.."]")
else
...
send(msg.chat_id_, msg.id_, ' ◍  تـم تـفعـيل الالعاب')
database:set(bot_id.."AL:AddS0FI:stats","✔")
end
if text == "+-+-+-+-+&--" and SudoBot(msg) then
send(msg.chat_id_, msg.id_, ' ◍ تـم تـعـطـيل الالعاب')
database:set(bot_id.."AL:AddS0FI:stats","✖")
end
...
send(msg.chat_id_, msg.id_, ' ◍ تـم تـعـطـيل الاسماء المكتومه')
...
send(msg.chat_id_, msg.id_, ' ◍  تـم تـفعـيل التوحيد')
...
send(msg.chat_id_, msg.id_, ' ◍ تـم تـعـطـيل التوحيد')
...
local Text = [[
┍━━━━━❲[🅢🅞🅞🅝](t.me/Soon_ban)❳━━━━━┑
☞𝚆𝙴𝙻𝙲𝙾𝙼𝙴 𝚃𝙾 𝚂𝙾𝚄𝚁𝙲𝙴 𝚂𝙾𝙾𝙽
☞𝚃𝙷𝙴 𝙱𝙴𝚂𝚃 𝚂𝙾𝚄𝚁𝙲𝙴 𝙾𝙽 𝚃𝙴𝙻𝙴
☞ 𝙵𝙾𝙻𝙻𝙾𝚆 𝚃𝙷𝙴 𝙱𝚄𝚃𝚃𝙾𝙽𝚂 𝙱𝙴𝙻𝙾𝚆
┕━━━━━❲[🅢🅞🅞🅝](t.me/Soon_ban)❳━━━━━┙
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '❲ᴘʀᴏɢʀᴀᴍ⒈❳',url="t.me/OSDDR"},{text = '❲ᴘʀᴏɢʀᴀᴍ⒉❳', url="t.me/Xxx_ksomk_xxX"}},
{{text = '❲ʙᴀɴᴅᴀ ᴏғғʟɪɴᴇ⒒❳', url="t.me/Q_0_ll"}},
{{text = '❲×:×:×𝙲𝙷×:×:×❳', url="t.me/Soon_ban"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/vagwg/24&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == 'مين نصبلك' or text == 'عايزه بوت' or text == 'عايز بوت' then
local Text = [[
[إذا تـوريـد بـوت 
تـواصل مـع الـمطـورين 
الـي فـي الاسـفل](t.me/TWASOLSOON)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '❲ᴘʀᴏɢʀᴀᴍ⒈❳',url="t.me/OSDDR"},{text = '❲ᴘʀᴏɢʀᴀᴍ⒉❳', url="t.me/Xxx_ksomk_xxX"}},
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/vagwg/17&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'طه🇦🇺',url="t.me/Xxx_ksomk_xxX"}},
}
local msg_id = msg.id_/2097152/0.5
...
if text =='تغير المطور الاساسي' and DevSoFi(msg) then
send(msg.chat_id_, msg.id_,'✫: ارسل ايدي المطور الاساسي الجديد')
database:set(bot_id..'Ed:DevSoFi',true) 
end
if text =='تغيير المطور الاساسي' and not DevBotsIs(msg) then
send(msg.chat_id_, msg.id_,'✫: تسرسح')
end
if database:get(bot_id.."Ed:DevSoFi") then
...
A:close()
database:del(bot_id.."Ed:DevSoFi")
end
end
...
if text == "لوخيروك" or text == "خيرني" or text == "لو خيروك" or text == "خيروك" then 
local TWEET_Msg = { 
...
Text = ' ◍  تـم تـفعـيل امر غنيلي الان ارسل غنيلي'
database:del(bot_id..'sing:for:me'..msg.chat_id_)  
else
Text = ' ◍ بـالـتـاكـيـد تـم تـفعـيل امر غنيلي تستطيع ارسال غنيلي'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n  ◍ تـم تـعـطـيل نسبه الانوثه'
else
Text = '\n  ◍ بـالـتـاكـيـدتـم تـعـطـيل نسبه الانوثه'
end
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'تفعيل all' and CoSu(msg) then   
if database:get(bot_id..'Cick:all'..msg.chat_id_) then
Text = '  ◍  تـم تـفعـيل امر @all'
database:del(bot_id..'Cick:all'..msg.chat_id_)  
else
Text = '  ◍ بـالـتـاكـيـد تـم تـفعـيل امر @all'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n  ◍ تـم تـعـطـيل امر @all'
else
Text = '\n  ◍ بـالـتـاكـيـدتـم تـعـطـيل امر @all'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
t = "  ◍ بـالـتـاكـيـدتـم تـعـطـيل ملف → "..file.."\n"
end
...
if file_bot then
io.close(file_bot)
t = "  ◍ بـالـتـاكـيـد تـم تـفعـيل ملف → "..file.." \n"
else
t = "  ◍  الملف  ☜ "..file.."\n  ◍  تـم تـفعـيل ملف \n"
end
local json_file, res = https.request("https://raw.githubusercontent.com/Ffasit/photo/main/File_Bot/"..file)
...
Text = '  ◍ بـالـتـاكـيـد تـم تـفعـيل امر تحويل'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n  ◍ تـم تـعـطـيل امر تحويل'
else
Text = '\n  ◍ بـالـتـاكـيـدتـم تـعـطـيل امر تحويل'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
send(msg.chat_id_, msg.id_,'  ◍ تـم تـعـطـيل الرفع') 
return false
end
...
send(msg.chat_id_, msg.id_,'  ◍ تـم تـعـطـيل الطرد') 
return false
end
function start_function(extra, result, success)
if tonumber(result.sender_user_id_) == tonumber(bot_id) then  
...
if database:get(bot_id..'Lock:Add:Bot'..msg.chat_id_) and not Constructor(msg) then
send(msg.chat_id_, msg.id_,'  ◍ تـم تـعـطـيل القتل') 
return false
end
function start_function(extra, result, success)
database:sadd(bot_id..'Zahf:User'..msg.chat_id_, result.sender_user_id_)
...
if database:get(bot_id..'Lock:kick'..msg.chat_id_) and not Constructor(msg) then
send(msg.chat_id_, msg.id_,'  ◍ تـم تـعـطـيل الحظر') 
return false
end
function start_function(extra, result, success)
if tonumber(result.sender_user_id_) == tonumber(bot_id) then  
...
send(msg.chat_id_, msg.id_," ✔️ تـم تـفعـيل الرابط") 
return false  
end
end
...
send(msg.chat_id_, msg.id_," ✘تـم تـعـطـيل الرابط") 
return false end
end
...
send(msg.chat_id_, msg.id_,"  ◍  تـم تـفعـيل الصوره") 
return false  
end
end
...
if Constructor(msg) then  
database:set(bot_id.."my_photo:status"..msg.chat_id_,true) 
send(msg.chat_id_, msg.id_,"  ◍  تـم تـفعـيل نسبه جمالك") 
return false  
end
end
...
send(msg.chat_id_, msg.id_,"  ◍ تـم تـعـطـيل نسبه جمالك") 
return false end
end
if text == "الرابط" then 
...
send(msg.chat_id_, msg.id_,'  ◍  تـم تـفعـيل ترحيب الجروب') 
return false  
end
...
database:del(bot_id..'Chek:Welcome'..msg.chat_id_) 
send(msg.chat_id_, msg.id_,'  ◍ تـم تـعـطـيل ترحيب الجروب') 
return false  
end
...
Text = '\n  ◍ بـالـتـاكـيـد تـم تـفعـيل الاذاعه'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n  ◍ تـم تـعـطـيل الاذاعه' 
else
Text = '\n  ◍  بـالـتـاكـيـدتـم تـعـطـيل الاذاعه'
end
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'تفعيل التواصل' and DevSoFi(msg) then  
...
own = 'مدير ،' else own = '' end
if database:sismember(bot_id..'Sudo:User'..msg.chat_id_, result.sender_user_id_) then
dev = 'مدير عام ،' else dev = '' end
if database:sismember(bot_id..'Sudo:User'..msg.chat_id_, result.sender_user_id_) then
dev = 'ادمن عام ،' else dev = '' end
...
Text = '  ◍  تـم تـفعـيل مغادرة البوت'
database:del(bot_id..'Left:Bot'..msg.chat_id_)  
else
Text = '  ◍ بـالـتـاكـيـد تـم تـفعـيل مغادرة البوت'
end
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'تعطيل المغادره' and DevSoFi(msg) then  
if not database:get(bot_id..'Left:Bot'..msg.chat_id_) then
Text = '  ◍ تـم تـعـطـيل مغادرة البوت'
database:set(bot_id..'Left:Bot'..msg.chat_id_,true)   
else
Text = '  ◍ بـالـتـاكـيـدتـم تـعـطـيل مغادرة البوت'
end
send(msg.chat_id_, msg.id_, Text) 
end
...
Text = '\n  ◍ بـالـتـاكـيـدتـم تـعـطـيل الردود'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n  ◍  تـم تـفعـيل الردود العامه' 
else
Text = '\n  ◍ بـالـتـاكـيـد تـم تـفعـيل الردود العامه'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n  ◍ تـم تـعـطـيل الردود العامه' 
else
Text = '\n  ◍ بـالـتـاكـيـدتـم تـعـطـيل الردود العامه'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n  ◍  بـالـتـاكـيـد تـم تـفعـيل الايدي'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n  ◍ بـالـتـاكـيـدتـم تـعـطـيل الايدي'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
database:del(bot_id..'Bot:Id:Photo'..msg.chat_id_) 
Text = '\n  ◍  تـم تـفعـيل الايدي بالصور' 
else
Text = '\n  ◍ بـالـتـاكـيـد تـم تـفعـيل الايدي بالصوره'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
if not database:get(bot_id..'Bot:Id:Photo'..msg.chat_id_)  then
database:set(bot_id..'Bot:Id:Photo'..msg.chat_id_,true) 
Text = '\n  ◍ تـم تـعـطـيل الايدي بالصوره' 
else
Text = '\n  ◍ بـالـتـاكـيـدتـم تـعـطـيل الايدي بالصوره'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n  ◍  تـم تـفعـيل الـحـظـر' 
else
Text = '\n  ◍ بـالـتـاكـيـد تـم تـفعـيل الـحـظـر'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n  ◍ بـالـتـاكـيـدتـم تـعـطـيل الحظر'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n  ◍ بـالـتـاكـيـد تـم تـفعـيل الرفع'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n  ◍ بـالـتـاكـيـدتـم تـعـطـيل الرفع'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
send(msg.chat_id_, msg.id_,'  ◍   رتـبتـك فـي الـبـوت  ☜ '..rtp)
end

if text == 'انا مين' and SudoBot(msg) then 
send(msg.chat_id_,msg.id_, '[انت مطور السورس روح قلبي 🧸🌚](t.me/Soon_ban)')
return false
end
...
send(msg.chat_id_, msg.id_,'  ◍ تـم تـعـطـيل امر اطردني') 
end
end
...
send(msg.chat_id_, msg.id_,'  ◍ تـم تـعـطـيل امر صيح') 
end
return false
end
...
send(msg.chat_id_, msg.id_,'  ◍ تـم تـعـطـيل امر  مين ضافني') 
end
end
...
Text = '  ◍  تـم تـفعـيل امر مين ضافني '
database:del(bot_id..'Added:Me'..msg.chat_id_)  
else
Text = '  ◍ بـالـتـاكـيـد تـم تـفعـيل امر مين ضافني '
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n  ◍ تـم تـعـطـيل امر مين ضافني '
else
Text = '\n  ◍ بـالـتـاكـيـدتـم تـعـطـيل امر مين ضافني '
end
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'تفعيل صيح' and Manager(msg) then   
if database:get(bot_id..'Seh:User'..msg.chat_id_) then
Text = '  ◍  تـم تـفعـيل امر صيح'
database:del(bot_id..'Seh:User'..msg.chat_id_)  
else
Text = '  ◍ بـالـتـاكـيـد تـم تـفعـيل امر صيح'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n  ◍ تـم تـعـطـيل امر صيح'
else
Text = '\n  ◍ بـالـتـاكـيـدتـم تـعـطـيل امر صيح'
end
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'تفعيل اطردني' and Manager(msg) then   
if database:get(bot_id..'Cick:Me'..msg.chat_id_) then
Text = '  ◍  تـم تـفعـيل امر اطردني إلى عايز يخرج يتنيل 😹'
database:del(bot_id..'Cick:Me'..msg.chat_id_)  
else
Text = '  ◍ بـالـتـاكـيـد تـم تـفعـيل امر اطردني مخلاص كفايه تفعيل الأمر 😾'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n  ◍ تـم تـعـطـيل امر اطردني اترزع هن بقى مفيش خروج 😹'
else
Text = '\n  ◍ بـالـتـاكـيـدتـم تـعـطـيل امر اطردني مفيش خروج يولاد القمر 😹'
end
send(msg.chat_id_, msg.id_,Text) 
end
if text == "صورتي"  then
...
if da.status_.ID == "ChatMemberStatusMember" then 
rtpa = 'عضو'
elseif da.status_.ID == "ChatMemberStatusEditor" then 
rtpa = 'مشرف' 
elseif da.status_.ID == "ChatMemberStatusCreator" then 
rtpa = 'المالك'
end
...
send(msg.chat_id_, msg.id_, t..'◁━━━━◖❲[🅢🅞🅞🅝](t.me/Soon_ban)❳◗━━━━▷\nاضغط علي الاسم ليتم نسخه\n◁━━━━◖❲[🅢🅞🅞🅝](t.me/Soon_ban)❳◗━━━━▷ٴ\n   ◍ ❲[🅢🅞🅞🅝](t.me/Soon_ban)❳  ◍  ')
end
if text == "تعطيل الابراج" and Manager(msg) then
send(msg.chat_id_, msg.id_, ' ◍ تـم تـعـطـيل الابراج')
database:set(bot_id.." sofi:brj_Bots"..msg.chat_id_,"close")
end
if text == "تفعيل الابراج" and Manager(msg) then
send(msg.chat_id_, msg.id_,' ◍  تـم تـفعـيل الابراج')
...
send(msg.chat_id_, msg.id_, ' ◍ تـم تـعـطـيل حساب العمر')
...
send(msg.chat_id_, msg.id_,' ◍  تـم تـفعـيل حساب العمر')
...
send(msg.chat_id_, msg.id_, ' ◍ تـم تـعـطـيل الافلام')
database:set(bot_id.."SOFI:movie_bot"..msg.chat_id_,"close")
end
if text == "تفعيل الافلام" and Mod(msg) then
send(msg.chat_id_, msg.id_,' ◍  تـم تـفعـيل الافلام')
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'BasketBoy', url="https://t.me/gamee?game=BasketBoy"},{text = 'BlockBuster',url="https://t.me/gamee?game=BlockBuster"}},   
{{text = 'KungFuInc', url="https://t.me/gamee?game=KungFuInc"},{text = 'MotoFX2', url="https://t.me/gamee?game=MotoFX2"}}, 
{{text = 'تشابه', url="https://t.me/gamee?game=DiamondRows"},{text = 'كره القدم', url="https://t.me/gamee?game=FootballStar"}}, 
{{text = 'ورق', url="https://t.me/gamee?game=Hexonix"},{text = 'لعبه 2048', url="https://t.me/awesomebot?game=g2048"}}, 
{{text = 'SQUARES', url="https://t.me/gamee?game=Squares"},{text = 'ATOMIC', url="https://t.me/gamee?game=AtomicDrop1"}}, 
{{text = 'CORSAIRS', url="https://t.me/gamebot?game=Corsairs"},{text = 'LumberJack', url="https://t.me/gamebot?game=LumberJack"}}, 
...
send(msg.chat_id_, msg.id_, '  ◍ تـم تـعـطـيل اوامر التسليه')
database:set(bot_id.."Fun_Bots:"..msg.chat_id_,"true")
end
if (text and text == "تفعيل اوامر التسليه") then 
send(msg.chat_id_, msg.id_, '   ◍  تـم تـفعـيل اوامر التسليه')
