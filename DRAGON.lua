...
if res ~= 200 then
print('\27[0;31m≪━━━━⁽♔₎ 𝗥𝗔𝗠𝗕𝗢 𖢝|:━━━━≫\n التوكن غير صحيح تاكد منه ثم ارسله')
else
io.write('\27[0;31m تم حفظ التوكن بنجاح \na≪━━━━⁽♔₎ 𝗥𝗔𝗠𝗕𝗢 𖢝|:━━━━≫\n27[0;39;49m')
database:set(id_server..":token",token)
end 
else
print('\27[0;35m≪━━━━⁽♔₎ 𝗥𝗔𝗠𝗕𝗢 𖢝|:━━━━≫ ┉\n لم يتم حفظ التوكن ارسل لي التوكن الان')
end 
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/Bandaa2/RAMBO/main/File_Bot/commands.lua") 
...
os.execute('wget https://raw.githubusercontent.com/Bandaa2/RAMBO/main/DRAGON.lua')
...
{{text = '♔₎𝙳𝚅 𝙼𝙰𝙽𝙾 ء |:☁',url="t.me/D_V_A7_Me_d"}},
{{text = '⁽♔₎𝚂𝙾𝚄𝚁𝙲𝙴 𝚁𝙰𝙼𝙱𝙾|:☁ ', url="t.me/So0u_rce_Line"}},
}
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/So0u_rce_Line&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/D_V_A7_Me_d&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if text == 'بيبو'  then
local Text = [[
 مبرمج سورس رامبو 🦅
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/D_V_B_a_h_e_r&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if text == 'باندا'  then
local Text = [[
...
elseif text == 'قفل رامبورسيه' and msg.reply_to_message_id_ == 0 and Manager(msg) then 
...
elseif text == 'فتح رامبورسيه' and msg.reply_to_message_id_ == 0 and Manager(msg) then 
...
if DevSoFi(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/Bandaa2/RAMBO/main/getfile.json")
if res == 200 then
...
local json_file, res = https.request("https://raw.githubusercontent.com/Bandaa2/RAMBO/main/File_Bot/"..file)
if res == 200 then
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝗖𝗵𝗮𝗻𝗻𝗲𝗹 𝗔𝗹𝗳𝗮 .',url="t.me/So0u_rce_Line"}},
}
local msg_id = msg.id_/2097152/0.5
...
[قناه السورس ☑️](t.me/So0u_rce_Line)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
...
{
{text = 'قناه السورس ☑️', url="t.me/So0u_rce_Line"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
