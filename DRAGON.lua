...
sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, result.photos_[0].sizes_[1].photo_.persistent_id_,Namebot,msg.id_/2097152/0.5,'md')
...
sendText(msg.chat_id_,Namebot,msg.id_/2097152/0.5,'md')
 end end
