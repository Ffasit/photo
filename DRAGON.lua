...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '❲ᴅᴇᴠᴇʟᴏᴘᴇʀ⒈❳',url="t.me/OSDDR"},{text = '❲ᴅᴇᴠᴇʟᴏᴘᴇʀ⒉❳', url="t.me/Xxx_ksomk_xxX"}},
{{text = '❲ʙᴀɴᴅᴀ ᴏғғʟɪɴᴇ⒒❳', url="t.me/Q_0_ll"}},
{{text = '²₀²₁ ˝ ₀₄ ˝₁₃  ₁₂:₀₀ ᴘᴍ', url="t.me/Soon_ban"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/Soon_ban/168&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
if text =='تغير المطور الاساسي' and DevBotsIs(msg) then
...
us = database:get(id_server..":SUDO:UserNameBot")
 ...
 agwa = agwa:gsub("%@", "")
keyboard = {} 
keyboard.inline_keyboard = {{{text = '❲....ᴛᴏ ᴀѕᴋ.....❳',url="t.me/TWASOLSOON"}},{{text = '²₀²₁ ˝ ₀₄ ˝₁₃  ₁₂:₀₀ ᴘᴍ ', url="t.me/Soon_ban"}}}
key = JSON.encode(keyboard)
local function getpro(extra, result, success)
if result.photos_[0] then
sendPhoto(msg.chat_id_, msg.id_, 0, 1, key, result.photos_[0].sizes_[1].photo_.persistent_id_,Namebot, msg.id_, msg.id_, "md")
else
SendMsgBySimba(msg.chat_id_, msg.id_,Namebot, key)
end
end
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '❲[🅢🅞🅞🅝](t.me/Soon_ban)❳',url="t.me/Soon_ban"}},
}
local msg_id = msg.id_/2097152/0.5
...
{{text = 'نسبه جمالي', url="https://t.me/Soon_ban/188"}},
...
{{text = 'لعبه الامثله', url="https://t.me/Soon_ban/140"}},
{{text = '◗القائمه الرائسيه◖', callback_data="/add"}},
{{text = '²₀²₁ ˝ ₀₄ ˝₁₃  ₁₂:₀₀ ᴘᴍ', url="t.me/Soon_ban"}},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Teext)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
