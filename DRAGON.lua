...
print('\27[0;31m𖠕━┅┅┄⟞❲🆂🅞🅞🅽❳⟝┄┉┉━𖠕n لم يتم حفظ ايدي المطور الاساسي ارسله مره اخره')
end 
os.execute('lua DRAGON.lua')
end
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '●ʙᴀɴᴅᴀ ᴏғғʟɪɴᴇ𖣌', url="t.me/Q_0_ll"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '●ᴏѕᴏѕ ᴏғғʟɪɴᴇ𖣌',url="t.me/OSDDR"},{text = '●ᴛᴀʜᴀ ᴏғғʟɪɴᴇ𖣌', url="t.me/Xxx_ksomk_xxX"}},
{{text = '●ʙᴀɴᴅᴀ ᴏғғʟɪɴᴇ𖣌', url="t.me/Q_0_ll"}},
{{text = '00:00', url="t.me/Soon_ban"}},
}
local msg_id = msg.id_/2097152/0.5
...
{{text = '●ᴏѕᴏѕ ᴏғғʟɪɴᴇ𖣌',url="t.me/OSDDR"},{text = '●ᴛᴀʜᴀ ᴏғғʟɪɴᴇ𖣌', url="t.me/Xxx_ksomk_xxX"}},
{{text = '●ʙᴀɴᴅᴀ ᴏғғʟɪɴᴇ𖣌', url="t.me/Q_0_ll"}},
{{text = '●ᴛᴏ ᴀsᴋ𖣌',url="t.me/TWASOLSOON"}}, 
{{text = '00:00 ', url="t.me/Soon_ban"}},
}
local msg_id = msg.id_/2097152/0.5
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '●ᴏѕᴏѕ ᴏғғʟɪɴᴇ𖣌',url="t.me/OSDDR"}},
}
local msg_id = msg.id_/2097152/0.5
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '●ᴛᴀʜᴀ ᴏғғʟɪɴᴇ𖣌',url="t.me/Xxx_ksomk_xxX"}},
}
local msg_id = msg.id_/2097152/0.5
...
if text == 'تم تعطيل الحمايه القصوه'and Mod(msg) and msg.reply_to_message_id_ == 0 then 
...
send(msg.chat_id_, msg.id_, t..'𖠕━┅┅┄⟞❲[🆂🅞🅞🅽](t.me/Soon_ban)❳⟝┄┉┉━𖠕\nاضغط علي الاسم ليتم نسخه\n𖠕━┅┅┄⟞❲[🆂🅞🅞🅽](t.me/Soon_ban)❳⟝┄┉┉━𖠕ٴ\n🐾 ❲[🅢🅞🅞🅝](t.me/Soon_ban)❳🐾 ')
end
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '❲'..UserName..'❳',url="t.me/"..b.first_name_}},
{{text = '00:00', url="t.me/Soon_ban"}}, 
}
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/'..b.first_name_..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end,nil)
...
if result.photos_[0] then
sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, result.photos_[0].sizes_[1].photo_.persistent_id_," نسبه جمالك هي "..rdbhoto.." يختي قمر يجدعان 🌚💕" )
else
send(msg.chat_id_, msg.id_,'لا تمتلك صوره في حسابك', 1, 'md')
  end end
tdcli_function ({ ID = "GetUserProfilePhotos", user_id_ = msg.sender_user_id_, offset_ = 0, limit_ = 1 }, getpro, nil)
...
----------------------------------------------------------------------------
if text == 'الالعاب' or text == 'العوده'  then 
local Text = '🎮 اهلا بك في قسم الالعاب '
local Key = {
{'العاب متطوره','العاب السورس'},
{'الاوامر','مميزات السورس'},
{'العوده'},
}
send_inline_key(msg.chat_id_,Text,Key)
end 
if text == 'العاب السورس' or text == 'العاب سورس'  then 
local Text = '🎮 اهلا بك في العاب السورس الاول اكتب تفعيل الالعاب'
local Key = {
...
if text == 'مميزات السورس' or text == 'المميزات السورس'  then 
local Text = '🦋 اهلا بك في مميزات السورس '
local Key = {
{'انصحني','تويت'},
{'لو خيروك','نكته'},
{'حروف','كتبات'},
