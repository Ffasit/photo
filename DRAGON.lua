...
if string.find(text,"start") or string.find(text,"start") then
local Namebot = (database:get(bot_id..'Name:Bot') or 'السعودي')
local DRAGON_Msg = {
'  انت الان المطور الاساسي في البوت  '..Namebot..'  يمكنك تحكم في البوتات من الكيبورد أسفل   ',
}

Namebot = DRAGON_Msg[math.random(#DRAGON_Msg)]
local function getpro(extra, result, success)
if result.photos_[0] then it
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/vagwg/22&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
