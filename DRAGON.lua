...
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/Qtdao/11&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
print("it is Bot")
Namebot = (database:get(bot_id.."Tshake:Name:Bot") or "ناسا")
local Texti = "٭ مرحبا انا  "..Namebot.." \n\n↞ اختصاصي ادارة المجموعات من السبام والخ..\n↞ للتفعيل ارفعني مشرف وارسل تفعيل في المجموعه ."
keyboard = {} 
keyboard.inline_keyboard ={{{text = "اضفني", switch_inline_query=" "}}}
local msg_id = msg.id_/2097152/0.5
local res = https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/Qtdao/11&caption=' .. URL.escape(Texti).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
end
...
local Text = [[
┄─━━━━━✧━━━━━─┄
⌾ |  [𝐖𝐞𝐥𝐜𝐨𝐦 𝐓𝐨 𝐒𝐨𝐮𝐫𝐜𝐞 𝐍𝐀𝐒𝐀⦒](t.me/ch_nasa)
⌾ |  [𝐓𝐡𝐞 𝐁𝐞𝐬𝐭 𝐒𝐨𝐮𝐫𝐜𝐞 𝐈𝐧 𝐓𝐞𝐥𝐠𝐫𝐚𝐦⦒](t.me/ch_nasa)
⌾ |  [𝐕𝐞𝐫𝐲 𝐏𝐫𝐨𝐭𝐞𝐜𝐭𝐞𝐝 𝐒𝐨𝐮𝐫𝐜𝐞 𝐍𝐀𝐒𝐀⦒](t.me/ch_nasa)
┄─━━━━━✧━━━━━─┄
]]
keyboard = {} 
keyboard.inline_keyboard = {
...
elseif database:sismember(bot_id..'Manager'..msg.chat_id_, msg.sender_user_id_) then
database:srem(bot_id..'onall'..msg.chat_id_, result.sender_user_id_)
elseif database:sismember(bot_id..'onall'..msg.chat_id_, msg.sender_user_id_) then
database:srem(bot_id..'S00F4:MN:TF'..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id..'Mod:User'..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id..'Special:User'..msg.chat_id_, result.sender_user_id_)
end
...
send(msg.chat_id_, msg.id_,' رتبتك ❮ '..rtp..' ❯ نور عيني 🌝\n  ⋆') 
end
...
send(msg.chat_id_,msg.id_, '[تدوم الضحكه يقلب..🌝❤️](t.me/ch_nasa)')
return false
end
end
end
...
first_name = '✧اسمك ↭ ❮`'..(result.first_name_)..'`❯'
else
first_name = ''
end   
if result.last_name_ then 
last_name = '✧اسمك الثاني ↭ ❮`'..(result.first_name_)..'`❯'
else
last_name = ''
end      
