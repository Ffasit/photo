...
function moall(msg)
local hash = database:sismember(bot_id..'moall'..msg.chat_id_, msg.sender_user_id_) 
if hash or SudoBot(msg) or DevSoFi(msg) or Sudo(msg) then       
return true    
else    
return false    
end 
...
if Text == '/added' and not  database:get(bot_id.."sing:for:me"..msg.chat_id_) then 
ght = math.random(1,25); 
local Text ='اكتب ثيم وسيتم اختيار ثيم اخار' 
keyboard = {}  
keyboard.inline_keyboard = { 
...
return https.request("https://api.telegram.org/bot"..token..'/editMessagemedia?chat_id='..Chat_id..'&media=https://t.me/gitt89/'..ght..'&caption='..URL.escape(Text)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
end
