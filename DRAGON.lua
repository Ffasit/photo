...
if not status_Link then Change:Chat:Photo
send(msg.chat_id_, msg.id_,"الرابط معطل")  
return false   
end 
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,ta) 
local linkgpp = json:decode(https.request('https://api.telegram.org/bot'..token..'/exportChatInviteLink?chat_id='..msg.chat_id_)) or database:get(bot_id.."Change:Chat:Photo"..msg.chat_id_) 
if linkgpp.ok == true then 
