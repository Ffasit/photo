...
sudo_users = {SUDO,1804133252,1774315810,1859008079,1708010431}   
...
if text == 'تتزوجيني' or text == 'زواج' or text == 'تجزوجني' then
local Text = [[
  طلب الزواج منك  في الحلال
  هل تقبلين ذلك 💏
...
keyboard.inline_keyboard = {
{
{text = 'موافقه🌝', callback_data="/help3"},{text = 'مش مواقفه 💔', callback_data="/help4"},
},
{
{text = '00:00', url="t.me/Soon_ban"},
},
...
local Teext =[[
 تم الموافقة علي الزواجه مبروك للعروسين 😎💕
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '00:00', url="t.me/Soon_ban"}},
