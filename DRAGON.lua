...
----------------------------------------------------------------------------
if text == 'الالعاب' or text == 'العوده'  and CoSu(msg) then 
...
if text == 'العاب السورس' or text == 'العاب سورس'  and CoSu(msg) then 
...
if text == 'مميزات السورس' or text == 'المميزات السورس'  and CoSu(msg) then 
