...
if text == '❲....ᴛᴏ ᴀѕᴋ.....❳' and DevSoFi(msg) then
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
[TWL](t.me/TWASOLSOON)
]] 
...
if database:sismember(bot_id..'moall'..msg.chat_id_, result.sender_user_id_) then
...
local Text =[[
   مرحبا بيك في الاوامر.
❛━━━━ ••• ━━━━❜
اختار الامر الي توريده
...
local Text =[[
     مرحبا بيك في الالعاب.
❛━━━━ ••• ━━━━❜
اختار اللعبه الي توريده
◁━━━━◖❲🅢🅞🅞🅝❳◗━━━━▷
[❲🅢🅞🅞🅝❳](t.me/Soon_ban)
]]
keyboard = {} 
