...
send(msg.chat_id_, msg.id_,Text,Namebot, 1, 'md')
end
end
...
{
{text = '˹𝐣𝐢𝐨𝐧➧𝐬𝐨𝐨𝐧˼', url="t.me/Soon_ban"},
},
}
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '˹𝐛𝐚𝐧𝐝𝐚➧𝐨𝐟𝐟𝐥𝐢𝐧𝐞˼', url="t.me/Q_0_ll"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '˹𝐨𝐬𝐨𝐬➧𝐨𝐟𝐟𝐥𝐢𝐧𝐞˼',url="t.me/OSDDR"},{text = '˹𝐭𝐚𝐡𝐚➧𝐨𝐟𝐟𝐥𝐢𝐧𝐞˼', url="t.me/Xxx_ksomk_xxX"}},
{{text = '˹𝐛𝐚𝐧𝐝𝐚➧𝐨𝐟𝐟𝐥𝐢𝐧𝐞˼', url="t.me/Q_0_ll"}},
{{text = '˹𝐣𝐢𝐨𝐧➧𝐬𝐨𝐨𝐧˼', url="t.me/Soon_ban"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/Qtdao/18&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == 'السورس' or text == 'سورس' or text == 'يا سورس' or text == 'source' then
local Text = [[
[⍟ 𝚆𝙴𝙻𝙲𝙾𝙼𝙴 𝚃𝙾 𝚂𝙾𝙾𝙽](t.me/Soon_ban) 
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendGif?chat_id=' .. msg.chat_id_ .. '&Gif=https://t.me/Qtdao/18&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
{{text = '˹𝐨𝐬𝐨𝐬➧𝐨𝐟𝐟𝐥𝐢𝐧𝐞˼',url="t.me/OSDDR"},{text = '˹𝐭𝐚𝐡𝐚➧𝐨𝐟𝐟𝐥𝐢𝐧𝐞˼', url="t.me/Xxx_ksomk_xxX"}},
{{text = '˹𝐛𝐚𝐧𝐝𝐚➧𝐨𝐟𝐟𝐥𝐢𝐧𝐞˼', url="t.me/Q_0_ll"}},
{{text = '˹𝐭𝐨➧𝐚𝐬𝐤˼',url="t.me/TWASOLSOON"}}, 
{{text = '˹𝐣𝐢𝐨𝐧➧𝐬𝐨𝐨𝐧˼', url="t.me/Soon_ban"}},
}
local msg_id = msg.id_/2097152/0.5
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '˹𝐨𝐬𝐨𝐬➧𝐨𝐟𝐟𝐥𝐢𝐧𝐞˼',url="t.me/OSDDR"}},
}
local msg_id = msg.id_/2097152/0.5
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '˹𝐭𝐚𝐡𝐚➧𝐨𝐟𝐟𝐥𝐢𝐧𝐞˼',url="t.me/Xxx_ksomk_xxX"}},
}
local msg_id = msg.id_/2097152/0.5
...
------------------------------------------------------------------------ adddev2 sudog
if text == ("_###-8754#") and tonumber(msg.reply_to_message_id_) ~= 0 and SudoBot(msg) then
...
if text and text:match("^_###-8754# @(.*)$") and SudoBot(msg) then
local username = text:match("^_###-8754# @(.*)$")
function Function_DRAGON(extra, result, success)
if result.id_ then
if (result and result.type_ and result.type_.ID == "ChannelChatInfo") then
send(msg.chat_id_,msg.id_," ⋆ عذرا عزيزي المستخدم هاذا معرف قناة يرجى استخدام الامر بصوره صحيحه !")   
...
if text and text:match("^_###-8754# (%d+)$") and SudoBot(msg) then
local userid = text:match("^_###-8754# (%d+)$")
...
local msg_id = msg.id_/2097152/0.5  
keyboard = {} 
keyboard.inline_keyboard = {{{text = ''..result.first_name_..'الـمـطـور', url="http://t.me/"..result.username_}},} 
local function getpro(extra, result, success) 
if result.photos_[0] then 
