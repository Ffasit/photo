...
if not database:get(bot_id..'Cick:rkoo'..msg.chat_id_) then
database:set(bot_id..":"..msg.sender_user_id_..":rkoo_Bots"..msg.chat_id_,"sendrkoo")
local LEADER_Msg = {
...
if text and text ~="صراحه" and database:get(bot_id..":"..msg.sender_user_id_..":rkko_Bots"..msg.chat_id_) == "sendrkoo" then
