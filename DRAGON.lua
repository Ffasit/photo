...
if text and text:match("^انذار @(.*)$") and Mod(msg) then
...
if text and text:match("^انذار (%d+)$") and Mod(msg) then
...
if not database:get(bot_id..'Cick:rkko'..msg.chat_id_) then
database:set(bot_id..":"..msg.sender_user_id_..":affa_Bots"..msg.chat_id_,"sendrkkoe")
local LEADER_Msg = {
...
if text and text ~="كشف الكذب" and database:get(bot_id..":"..msg.sender_user_id_..":affa_Bots"..msg.chat_id_) == "sendrkkoe" then
