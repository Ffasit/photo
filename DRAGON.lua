...
┕─━─━─┑[🅢🅞🅞🅝](t.me/Soon_ban)┍─━─━─┙
 ...
 us = database:get(bot_id..":SUDO:UserNameBot")
keyboard = {} 
keyboard.inline_keyboard = {
...
{{text = '  اضف البوت الي مجموعتك ',url="t.me/"..us.."?startgroup=start"}},
 ...
 us = database:get(bot_id..":SUDO:UserNameBot")
 agwa = database:get(bot_id..":SUDO:USERNAME")
 agwa = agwa:gsub("%@", "")
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/Soon_ban/&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo='..link..'&caption=' .. URL.escape(mms).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true")
...
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo='..linkgpp.result..'&caption=' .. URL.escape(mms).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true")
