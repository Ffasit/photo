...
if msg.content_.ID == "MessageChatDeleteMember" and tonumber(msg.content_.user_.id_) == tonumber(msg) then 
database:srem("faeder:addg"..bot_id, msg.chat_id_) 
database:del(bot_id.."bot:charge:"..msg.chat_id_)
